@testset "buildSquare" begin
    ...
    @test boundary_info.side_list[1][2].element.id == 3
    @test boundary_info.side_list[1][2].side == 1

    # Sideset 2
    @test length(boundary_info.side_list[2]) == 2
    @test boundary_info.side_list[2][1].element.id == 3
    ...
    @test boundary_info.side_list[3][1].element.id == 2
    ...
    @test boundary_info.side_list[4][2].element.id == 2
